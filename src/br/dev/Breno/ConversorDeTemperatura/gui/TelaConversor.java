...
public class TelaConversor {
	...
	public void criarTelaConversor(String tituloDaTela) {
		...
		// FEHRANHEIT
		buttonFahrenheit = new JButton();// Criando objeto JButton
		buttonFahrenheit.setText("FAHRENHEIT");// Defnindo nome do botão
		buttonFahrenheit.setBounds(50, 100, 150, 40);// Definindo o tamanho e posição do botão Fahreinheit

		// KELVIN
		buttonKelvin = new JButton();// criando objeto JButton
		buttonKelvin.setText("KELVIN");// Definindo nome do botão
		buttonKelvin.setBounds(210, 100, 150, 40);// Definindo tamanho e posição do botão kelvin.
		...
		labelMensagemErro.setBounds(140, 140, 250, 60);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (temperatura.getCelsius() > 0) {
						...
						labelMensagemErro.setText("KELVIN INVALIDO");
						labelMensagemErro.setVisible(true);
						// Verificando se celsius é valido para realizar a conversão se não exibir uma
						// mensagem de erro
					}

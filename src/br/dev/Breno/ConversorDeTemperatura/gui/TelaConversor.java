	...
	public void criarTelaConversor(String tituloDaTela) {
		...
		buttonFahrenheit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// serão executados e se
				// ocorrer uma exeção o catch vai exibir a mensagem de erro. Try e catch são
				// ultilizados para tratar exeções.
				try {
					labelMensagemErro.setVisible(false);
					// Mensagem de erro vai estar invisivel
					...
					if (celsiusLDouble >= -273.15) {
						...
						// Tornando a mensagem de erro visivel
